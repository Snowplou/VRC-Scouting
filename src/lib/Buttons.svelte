...
<div>
    <button on:click={updateSkills} on:keydown={updateSkills}>Skills</button>
    <button>Filters</button>
    <button on:click={() => showCategories = !showCategories} on:keypress={() => showCategories = !showCategories}>Categories</button>
</div>
